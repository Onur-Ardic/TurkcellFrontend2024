function UI() {}
UI.prototype.createElement = function (
  tag,
  classNames = [],
  appendChilds = [],
  textContent
...
UI.prototype.removeChilds = function (element) {
...
UI.prototype.updateMovie = function (name) {
  updateMode = true;
  submitButton.textContent = "Edit";
  const moviesArray = storage.getMoviesLocal();
  movieIndex = moviesArray.findIndex((movie) => movie.name === name);
  nameInput.value = moviesArray[movieIndex].name;
  yearInput.value = moviesArray[movieIndex].year;
  directorInput.value = moviesArray[movieIndex].director;
  genreInput.value = moviesArray[movieIndex].genre;
  imageInput.value = moviesArray[movieIndex].image;
};
UI.prototype.clean = function () {
  nameInput.value = "";
  directorInput.value = "";
  yearInput.value = "";
  genreInput.value = "";

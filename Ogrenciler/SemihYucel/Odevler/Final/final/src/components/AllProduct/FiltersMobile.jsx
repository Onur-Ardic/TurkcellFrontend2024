...
const FiltersMobile = ({ categories, colors, sizes, styles }) => {
  ...
  const handleSizeChange = (selectedSize) => {
    setFilters((prevFilters) => {
      const newSizeArray = prevFilters.sizes.includes(selectedSize)
        ? prevFilters.sizes.filter((size) => size !== selectedSize) // Remove size if already selected
        : [...prevFilters.sizes, selectedSize]; // Add size if not selected
                    ...
                    renderThumb={({ props, index }) => (
                      <div
                        ...
                        style={{
                          ...
                          alignItems: "center",
                          zIndex: -1, // Ensure this is above the track but not higher than the accordion header
                        }}
                      >
                        <div
                          style={{
                            position: "absolute",
                            top: "30px", // Adjust this value to prevent overlap
                            left: "-10px",
                            color: "black",
                            fontWeight: "bold",
                            fontSize: "12px",
                            padding: "2px 6px",
                            borderRadius: "4px",
                            background: "white", // Optional: add background color to enhance visibility
                            zIndex: -1, // Make sure this is less than the thumb for better layering control
                          }}
                        >
                          ${priceRange[index]}
                        </div>
                    ...
                    styles.map((style) => (
                      <div
                        ...
                        className={`style-item mb-2 ${
                          filters.style === style ? "selected text-warning" : ""
                        }`}

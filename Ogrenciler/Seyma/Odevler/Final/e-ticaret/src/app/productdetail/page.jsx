              ...
              <div className="col-lg-6 col-10 d-flex gap-2">
                <div className="col-lg-3 row">
                   <div className="imgContainerPrd">
                        <a href="#">
                          <img src="blacktshirt.png" alt="" className="w-100"/></a>
                    </div>
                    <div className="imgContainerPrd">
              ...
              <div className="col-lg-6 col-10">
                <div className="ps-md-4 ps-xl-5">
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <p className="fs-sm mb-0">Made from high-quality denim fabric, this midi skirt offers durability and comfort for all-day wear. The mid-length design strikes the perfect balance between casual and chic, making it suitable for various occasions, from casual outings to semi-formal events.</p>
                  ...
                  <div className="d-flex gap-3 pb-3 pb-lg-4 mb-3">
                    ...
                    <button type="button" className="btn btn-lg btn-dark w-100">Add to cart</button>
                  </div>

            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Group controlId="formMovieAuthor">
                        ...
                        <Form.Control type="text" name="author" value={movieData.author} onChange={handleChange} />
                    </Form.Group>
                    <Form.Group controlId="formMovieCategory">
                        <Form.Label>Kategori</Form.Label>
                        <Form.Control type="text" name="category" value={movieData.category} onChange={handleChange} />
                    </Form.Group>
                    <Form.Group controlId="formMovieDate">
                        <Form.Label>Yayınlanma Tarihi</Form.Label>
                        <Form.Control type="text" name="releaseDate" value={movieData.releaseDate} onChange={handleChange} />
                    </Form.Group>

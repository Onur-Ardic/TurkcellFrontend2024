...
const Colors = ({ selectedColors, onChange }) => {
  const [selectedColor, setSelectedColor] = useState(
    selectedColors[0] || "brown"
  );
  ...
  return (
    <>
      <span onClick={() => handleColorChange("brown")} className="color-brown">
      ...
      <span onClick={() => handleColorChange("green")} className="color-green">
      ...
      <span onClick={() => handleColorChange("blue")} className="color-blue">

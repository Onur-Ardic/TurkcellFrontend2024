...
const Cart = () => {
    return (
        <>
            <Header />
            <Navbar />
            <div className="container d-flex align-items-center my-4 pt-3" style={{ borderTop: "1px solid #0000001A" }}>
                Home
                <svg className="me-1 mt-1" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">

const BlackBox = () => {
    return (
        <div className="m-2 mt-5">
            <div className="blackBox-container container p-5 my-5">
                <div className="row d-flex align-items-center">
                    <div className="col-12 col-md-7">
                        <h2 className="text-white">STAY UPTO DATE ABOUT <br /> OUR LATEST OFFERS</h2>
                    </div>
                    <div className="col-12 col-md-5">
                        <div className="input-container d-flex position-relative mb-3">
                            ...
                            <input className="bg-light" placeholder="Enter your email address"></input>
                        </div>
                        <button className="subscribe-button btn bg-light w-100">Subscribe to Newsletter</button>
                    </div>
                </div>
            </div>
        </div>

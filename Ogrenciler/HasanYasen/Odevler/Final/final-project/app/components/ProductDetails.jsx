                ...
                <div className="row">
                    <div className="left col-12 col-md-6 gap-2">
                        <div className="col-12 col-md-3 small-images">
                            <div className="row">
                                <div className="col-4 col-md-12">
                                    <Image src={product?.imgUrl} className="img-fluid mb-3 image first-image" width={152} height={167} />
                                </div>
                                <div className="col-4 col-md-12">
                                    <Image src={product?.imgUrl} className="img-fluid mb-3 image" width={152} height={167} />
                                </div>
                                <div className="col-4 col-md-12">
                                    <Image src={product?.imgUrl} className="img-fluid mb-3 image" width={152} height={167} />
                                </div>
                        ...
                        <div className="col-12 col-md-9 large-image">
                            <Image src={product?.imgUrl} className="img-fluid mb-3 image w-100" width={430} height={530} />
                        </div>
                    </div>

                    <div className="right col-12 col-md-6">
                        {product.title && <h2 className="mb-2">{product.title.toUpperCase()}</h2>}
                        <div className="d-flex gap-2">
                            <Image className="mt-1" src={product?.starImgUrl} width={80} height={18} />
                            <p className="fw-bold">{product?.star}<span className="fw-light">/5</span></p>
                        </div>
                        ...
                        <p className="text-muted product-content pb-3">
                            ...
                            Phasellus imperdiet, sapien a accumsan mollis, felis erat fermentum augue, id blandit ex orci lobortis diam.
                            Donec gravida euismod aliquam.
                        </p>
                        <div>
                            ...
                            <div className="d-flex gap-2 colors pb-3">
                                {colors.map((color, index) => {
                                    ...
                                    return (
                                        <svg className="mb-1" key={index} width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="18.5" cy="18.5001" r="18.5" fill={color} />
                                            <circle cx="18.5" cy="18.5001" r="17.5" stroke="black" strokeOpacity="0.2" strokeWidth="2" />
                                            {(color == product.color) && (
                                                <path
                        ...
                        <div className="buttons row">
                            <div className="col-4 quantity">
                                <div className="minus-plus-btn w-100 d-flex justify-content-between align-items-center">
                                    {quantity <= 1
                                        ...
                                        :
                                        <div className="fs-2 btn small-btn d-flex align-items-center mt-1" onClick={() => setQuantity(quantity - 1)}>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M17.8125 10C17.8125 10.2486 17.7137 10.4871 17.5379 10.6629C17.3621 10.8387 17.1236 10.9375 16.875 10.9375H3.125C2.87636 10.9375 2.6379 10.8387 2.46209 10.6629C2.28627 10.4871 2.1875 10.2486 2.1875 10C2.1875 9.75136 2.28627 9.5129 2.46209 9.33709C2.6379 9.16127 2.87636 9.0625 3.125 9.0625H16.875C17.1236 9.0625 17.3621 9.16127 17.5379 9.33709C17.7137 9.5129 17.8125 9.75136 17.8125 10Z" fill="black" />
                                            </svg>
                                    ...
                                    <div className="fs-3 d-flex align-items-center">{quantity}</div>
                                    <div className="fs-2 btn small-btn d-flex align-items-center mt-1" onClick={() => setQuantity(quantity + 1)}>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="col-8 addToCart">
                                <button onClick={handleAddToCart} className="btn btn-dark text-center text-white w-100">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </div>
